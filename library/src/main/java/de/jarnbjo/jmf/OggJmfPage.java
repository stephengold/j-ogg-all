...
public final class OggJmfPage extends OggPage {
     ...
     * @return an ogg page created by reading data from the specified channel,
     * starting at the current position
     * @throws OggFormatException if the data read from the specified channel is
     * not matching the specification for an ogg page
     * @throws EndOfOggStreamException if it is not possible to read an entire
     * ogg page from the specified channel
     * @throws IOException if some other IO error is detected when reading from
     * the channel
     *
