...
public class OggPage {
     ...
     * data read. If the parameter {@code skipData} is set to {@code true}, the
     * actual page segments (page data) is skipped and not read into memory.
     ...
     * @param skipData if set to {@code true}, the actual page data is not read
     * into memory
     * @return an ogg page created by reading data from the specified source,
     * starting at the current position
     * @throws OggFormatException if the data read from the specified source is
     * not matching the specification for an ogg page
     * @throws EndOfOggStreamException if it is not possible to read an entire
     * ogg page from the specified source
     * @throws IOException if some other I/O error is detected when reading from
     * the source
     *
     ...
     * read. If the parameter {@code skipData} is set to {@code true}, the
     * actual page segments (page data) is skipped and not read into memory.
     * This mode is useful when scanning through an ogg file to build a seek
     * table.
     *
